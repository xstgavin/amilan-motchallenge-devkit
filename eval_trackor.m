...
benchmarkDir = '../data/homebrain/homebrain_short/';
[allMets, metsBenchmark] =evaluateTracking('homebrain_short.txt', 'res/homebrain/homebrain_short/', benchmarkDir, 'homebrain');